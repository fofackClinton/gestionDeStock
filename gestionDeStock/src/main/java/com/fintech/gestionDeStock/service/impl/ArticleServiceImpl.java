...
public class ArticleServiceImpl implements ArticleService {
    ...
    public ArticleDto findById(Integer id) {
        ...
        return Optional.of(ArticleDto.fromEntity(article.get())).orElseThrow(() -> new EntityNotFoundException(
                "L\'article avec l'id " + id + "n'existe pas dans la BDD", ErrorCode.ARTICLE_NOT_FUND));
    }
    ...
    public ArticleDto findByCodeArticle(String codeArticle) {
        ...
        return Optional.of(ArticleDto.fromEntity(article.get()))
                .orElseThrow(() -> new EntityNotFoundException("L'article avec le code " + codeArticle + "n'existe pas",
